...
namespace Infrastructure.Common.Utilities
{
    ...
    {
        public static void RegisterAllEntities<BType>(this ModelBuilder modelBuilder, params Assembly[] assemblies)
        {
            var types = assemblies.SelectMany(a => a.GetExportedTypes())
                 .Where(a => a.IsClass && !a.IsAbstract && typeof(BType).IsAssignableFrom(a));
